...
export default function LoginLayout({
	...
	return (
		<div className="size-full max-h-screen overflow-hidden md:flex">
			<div className="relative overflow-hidden hidden md:flex w-1/2 bg-gradient-to-tr from-purple-900 to-secondary-600 px-7 justify-around items-center">
				<article>
					...
					<div className="flex gap-1 items-center">
						<Link
							className="block w-28 bg-white text-secondary-800 mt-4 py-2 rounded-2xl font-bold mb-2 mr-2 text-center"
							href="/">
							خانه
						</Link>
						<Link
			...
			<main className="flex md:w-1/2 h-full overflow-auto justify-center py-10 items-center bg-white max-md:bg-gradient-to-tr max-md:from-purple-900 max-md:to-secondary-600">
				{children}
			</main>
		</div>
	);
