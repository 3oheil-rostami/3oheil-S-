...
export default function LoginLayout({
	...
	return (
		<MainLayout>
			<div className="h-screen w-full max-h-screen overflow-hidden md:flex">
				...
				<div className="flex md:w-1/2 h-full overflow-auto justify-center py-10 items-center bg-white max-md:bg-gradient-to-tr max-md:from-purple-900 max-md:to-secondary-600">
					{children}
				</div>
			</div>
		</MainLayout>
