...
export default function Button({
	...
	return (
		<button
			...
			disabled={isDisabled}
			{...reset}
			className={`flex justify-center items-center gap-2 outline-none px-4 py-2 font-medium transition-all duration-300 disabled:bg-neutral-700 disabled:text-neutral-200 disabled:cursor-not-allowed ${styles} ${className}`}>
			{children}
		</button>
	);
}
